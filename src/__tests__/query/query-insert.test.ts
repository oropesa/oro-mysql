...
const TABLE_NAME_EASY = 'test_insert_easy_ts';
const UNIQUE_NAME_EASY = 'test_insert_easy_ts_name';

const TABLE_NAME_CODE = 'test_insert_code_ts';
const TABLE_NAME_LABEL = 'test_insert_label_ts';
...
afterAll(async () => {
  ...
  await oMysql.query(`DROP TABLE IF EXISTS ${TABLE_NAME_CODE}`);
  await oMysql.query(`DROP TABLE IF EXISTS ${TABLE_NAME_LABEL}`);
  await oMysql.poolClose();
});
...
describe('query when pool not opened', () => {
  test('query before poolOpen', async () => {
    ...
    const result = await oMysql.query(`INSERT INTO ${TABLE_NAME_EASY} ( name ) VALUES ( 'chacho' )`);
...
describe('easy query INSERT', () => {
  test('easy query INSERT bad', async () => {
    ...
    await oMysql.poolOpen();
    const result = await oMysql.query(`INSERT INTO ${TABLE_NAME_EASY} ( namee ) VALUES ( 'chacho' )`);
    await oMysql.poolClose();
  ...
  test('easy query INSERT ok get id', async () => {
    ...
    await oMysql.poolOpen();
    const result = await oMysql.query(`INSERT INTO ${TABLE_NAME_EASY} ( name ) VALUES ( 'loco' )`, {
      format: 'id',
    });
    await oMysql.poolClose();
  ...
  test('easy query INSERT ko unique', async () => {
    ...
    await oMysql.poolOpen();
    const result = await oMysql.query(`INSERT INTO ${TABLE_NAME_EASY} ( name ) VALUES ( 'chacho' )`, { format: 'id' });
    await oMysql.poolClose();
  ...
  test('easy query INSERT ok get bool', async () => {
    ...
    await oMysql.poolOpen();
    const result = await oMysql.query(`INSERT INTO ${TABLE_NAME_EASY} ( name ) VALUES ( 'tio' )`, {
      format: 'bool',
    });
    await oMysql.poolClose();
  ...
  test('fnSanitize query INSERT ok get id', async () => {
    ...
    await oMysql.poolOpen();
    const result = await oMysql.query(`INSERT INTO ${TABLE_NAME_EASY} ( id, name ) VALUES ( 6, 'foo' )`, {
      format: 'id',
      fnSanitize: (value: number) => ({ rowId: value }),
    });
    await oMysql.poolClose();
...
describe('code: query INSERT', () => {
  test('code query INSERT ok get id', async () => {
    ...
    await oMysql.poolOpen();
    const result = await oMysql.query(`INSERT INTO ${TABLE_NAME_CODE} ( name ) VALUES ( 'chacho' ), ( 'loco' )`, {
      format: 'id',
    });
    const array = await oMysql.query<CodeObject>(`SELECT * FROM ${TABLE_NAME_CODE} ORDER BY code`, {
      format: 'array',
    });
    await oMysql.poolClose();
  ...
  test('code query INSERT ok get another id', async () => {
    ...
    await oMysql.poolOpen();
    const result = await oMysql.query(`INSERT INTO ${TABLE_NAME_CODE} ( name ) VALUES ( 'foo' ), ( 'bar' )`, {
      format: 'id',
    });
    const array = await oMysql.query<CodeObject>(`SELECT * FROM ${TABLE_NAME_CODE} ORDER BY code`, {
      format: 'array',
...
describe('label: query INSERT', () => {
  test('label query INSERT ok get id', async () => {
    ...
    await oMysql.poolOpen();
    const result = await oMysql.query(
      `INSERT INTO ${TABLE_NAME_LABEL} ( label, name ) VALUES ( 'chacho', 'chacho' ), ( 'loco', 'loco' )`,
      { format: 'id' },
    );
    const array = await oMysql.query<LabelObject>(`SELECT * FROM ${TABLE_NAME_LABEL} ORDER BY label`, {
      format: 'array',
    });
    await oMysql.poolClose();
